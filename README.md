...
## Details
The Stan script for the Bayesian hierarchical model along with an R script to run the model are both included in the ***"code"*** folder. Different data used for this analysis are provided inside the ***"data"*** folder.
